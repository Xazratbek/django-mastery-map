...
const projectMappingByIsland: Record<string, string[]> = {
  ...
  'ai-confusion-radar': [
    'apps/ai/ va apps/analytics/',
    'apps/courses/, lessons/, sessions/ modellari',
    'services/ va selectors/ qatlamlari',
    'celery.py va tasks.py',
    'docker-compose.yml va Dockerfile'
  ],
};
...
,
  ...
  {
    dayNumber: 32,
    title: "DRF Request/Response Flow",
    shortDescription: "request.data, Response va status code mental modeli",
    longDescription: "DRF request obyektini Django requestdan kengaytiradi. request.data, request.query_params va Response bilan yagona API kontraktini qurishni o'rganasiz.",
    category: "API & REST Foundations",
    islandId: "drf-setup",
    difficulty: "Oson",
    todayFocus: "request.data, Response, status codes va APIView/@api_view farqi.",
    whyItMatters: "API bir xil formatda javob qaytarsa frontend va mobil clientlar barqaror ishlaydi.",
    doNotStudyToday: ["Nested serializerlar", "JWT va permissionlar"],
    deepWorkPlan: standardDeepWork("Request/Response mental modeli", "APIView va @api_view farqi, status code ishlatish", "GET/POST endpoint yozib, statuslar bilan test qilish"),
    tasks: ["GET va POST endpoint yozish", "request.data va query_params ni ajratish", "Response status code bilan qaytarish"],
    exercises: ["Notog'ri input bo'lsa 400 qaytaradigan endpoint yozing."],
    deliverable: "2 ta endpoint: biri GET list, biri POST create va to'g'ri status code qaytaradi.",
    checklist: ["request.data ishladi", "status=201/400 ishlatildi"],
    readinessCriteria: ["Postman orqali JSON response va status code mos keladi."],
    commonMistakes: ["Django JsonResponse bilan DRF Response ni aralashtirish"],
    ifStuck: "DRF tutorialdagi Request/Response bo'limini qayta o'qing.",
    terms: [
      { term: "request.data", definition: "DRF request ichida JSON/body ma'lumotini avtomatik parse qilgan qiymat." },
      { term: "Response", definition: "DRF ning HTTP response classi; JSON render va status kodni boshqaradi." }
    ]
  },
  {
    dayNumber: 33,
    title: "Serializer Basics & ModelSerializer",
    shortDescription: "Serializer, ModelSerializer va data contract",
    longDescription: "Serializer DRFda input/output formatini belgilaydi. Bugun oddiy Serializer va ModelSerializer bilan qanday qilib JSON qaytarish va validatsiya qilishni o'rganasiz.",
    category: "DRF Setup & Serializers",
    islandId: "drf-serializers",
    difficulty: "O'rtacha",
    todayFocus: "Serializer va ModelSerializer farqi, field mapping, to_representation.",
    whyItMatters: "Serializer API kontrakti. U to'g'ri bo'lsa, clientlar barqaror ishlaydi va validation aniq bo'ladi.",
    doNotStudyToday: ["ViewSetlar", "JWT"],
    deepWorkPlan: standardDeepWork("Serializer nima va qachon ishlatiladi", "ModelSerializer bilan CRUD data formatlash", "2 ta serializer yozib data qaytarish"),
    tasks: ["Oddiy Serializer yozish", "ModelSerializer yozish", "Serializer.data orqali JSON qaytarish"],
    exercises: ["ModelSerializerga read_only field qo'shing va response tekshiring."],
    deliverable: "2 ta serializer: biri oddiy, biri ModelSerializer, ishlaydigan API response.",
    checklist: ["fields to'g'ri ishladi", "Serializer.data JSON qaytardi"],
    readinessCriteria: ["Postman orqali serializer data to'g'ri formatda chiqadi."],
    commonMistakes: ["Serializer o'rniga model instance qaytarish", "ModelSerializerda fields unutish"],
    ifStuck: "DRF serializer docs bo'limini qayta ko'ring.",
    terms: [
      { term: "Serializer", definition: "Python obyektini JSON formatga o'giruvchi va inputni tekshiruvchi DRF class." },
      { term: "ModelSerializer", definition: "Model fieldlarini avtomatik ulaydigan serializer turi." }
    ]
  },
  {
    dayNumber: 34,
    title: "Validation & Custom Fields",
    shortDescription: "Field-level, object-level validation va custom fields",
    longDescription: "DRF validatsiyasi API sifatini oshiradi. Field validator, validate_<field> va validate() orqali inputni tozalaysiz. Custom fieldlar bilan maxsus format yaratasiz.",
    category: "DRF Setup & Serializers",
    islandId: "drf-serializers",
    difficulty: "O'rtacha",
    todayFocus: "Validation zanjiri, custom validatorlar va custom fieldlar.",
    whyItMatters: "Notog'ri input backendga kirsa bug va security muammo bo'ladi. Validation buni to'xtatadi.",
    doNotStudyToday: ["Permissions", "Pagination"],
    deepWorkPlan: standardDeepWork("Validation ketma-ketligi", "Field/object level validation yozish", "Custom validator bilan real input tekshirish"),
    tasks: ["validate_<field> yozish", "validate() ichida cross-field tekshirish", "Custom validator function yaratish"],
    exercises: ["Price manfiy bo'lsa 400 qaytaradigan serializer yozing."],
    deliverable: "Validation ishlaydigan serializer va xato response formati.",
    checklist: ["Field-level validation ishladi", "Object-level validation ishladi"],
    readinessCriteria: ["Notog'ri input 400 bilan qaytadi va error keylar to'g'ri chiqadi."],
    commonMistakes: ["Validationni viewga yozib qo'yish", "raise ValidationError qilmaslik"],
    ifStuck: "Serializer validation bo'limini docsdan o'qing.",
    terms: [
      { term: "validate_<field>", definition: "Bitta field qiymatini tekshiradigan serializer metodi." },
      { term: "validate()", definition: "Bir nechta fieldni birgalikda tekshiradigan object-level metod." }
    ]
  },
  {
    dayNumber: 35,
    title: "Relationships & Nested Serializers",
    shortDescription: "FK, M2M, nested serializerlar va related fieldlar",
    longDescription: "Real APIlarda resurslar bog'langan bo'ladi. ForeignKey va ManyToMany ni serializerlarda to'g'ri ko'rsatish, nested data qaytarish va write logikasini o'rganasiz.",
    category: "DRF Setup & Serializers",
    islandId: "drf-serializers",
    difficulty: "O'rtacha",
    todayFocus: "PrimaryKeyRelatedField, SlugRelatedField, nested serializer, depth.",
    whyItMatters: "Related data to'g'ri chiqmasa API foydasiz bo'lib qoladi. Relationship mapping API sifatini belgilaydi.",
    doNotStudyToday: ["Authentication", "Caching"],
    deepWorkPlan: standardDeepWork("Model relationshiplar va serializer mapping", "Nested serializer va related fieldlar", "Write (create/update) uchun nested data ishlatish"),
    tasks: ["PrimaryKeyRelatedField ishlatish", "SlugRelatedField bilan human-readable output", "Nested serializer yozish"],
    exercises: ["Book + Author nested response qaytaring va author id bilan create qiling."],
    deliverable: "Relationshiplar to'g'ri ko'rsatilgan API response va create flow.",
    checklist: ["Related field ishladi", "Nested serializer data to'g'ri chiqdi"],
    readinessCriteria: ["N+1 yo'qligini tekshirib ko'ring (select_related)."],
    commonMistakes: ["depth=1 ni haddan tashqari ishlatish", "Nested write logikasini unutish"],
    ifStuck: "DRF relations bo'limini o'qing.",
    terms: [
      { term: "PrimaryKeyRelatedField", definition: "Related modelni id orqali ko'rsatish uchun field." },
      { term: "Nested serializer", definition: "Related obyektni ichki JSON ko'rinishida chiqarish." }
    ]
  },
  {
    dayNumber: 36,
    title: "GenericAPIView & Mixins",
    shortDescription: "List, Create, Retrieve uchun tayyor mixinlar",
    longDescription: "GenericAPIView va mixinlar orqali ko'p yoziladigan CRUD kodlar qisqaradi. Bugun mixinlar bilan API view yozishni o'rganasiz.",
    category: "DRF Views, ViewSets & Routers",
    islandId: "drf-views",
    difficulty: "O'rtacha",
    todayFocus: "ListModelMixin, CreateModelMixin va RetrieveModelMixin ishlatish.",
    whyItMatters: "Takroriy kod kamayadi, standart CRUD tez yoziladi.",
    doNotStudyToday: ["ViewSet advanced actionlar", "JWT"],
    deepWorkPlan: standardDeepWork("GenericAPIView nima", "Mixins kombinatsiyasi", "List/Create view yozish"),
    tasks: ["GenericAPIView yaratish", "ListModelMixin bilan list endpoint", "CreateModelMixin bilan create endpoint"],
    exercises: ["RetrieveModelMixin bilan detail endpoint yozing."],
    deliverable: "3 ta endpoint (list/create/detail) mixinlar orqali ishlaydi.",
    checklist: ["queryset va serializer_class to'g'ri ishladi"],
    readinessCriteria: ["List va create bitta viewda ishlaydi."],
    commonMistakes: ["get_queryset yozmaslik", "serializer_class ni unutish"],
    ifStuck: "DRF generics + mixins bo'limini o'qing.",
    terms: [
      { term: "GenericAPIView", definition: "DRFning umumiy CBV bazasi, queryset/serializer bilan ishlaydi." },
      { term: "Mixin", definition: "Qayta ishlatiladigan funksional modul (list/create/retrieve)." }
    ]
  },
  {
    dayNumber: 37,
    title: "Generic Views (ListCreate, RetrieveUpdateDestroy)",
    shortDescription: "Eng ko'p ishlatiladigan DRF generic viewlar",
    longDescription: "ListCreateAPIView va RetrieveUpdateDestroyAPIView eng tez CRUD yozish yo'li. Bugun ularni bir xil endpointlarda ishlatishni o'rganasiz.",
    category: "DRF Views, ViewSets & Routers",
    islandId: "drf-views",
    difficulty: "O'rtacha",
    todayFocus: "Generic viewlarni to'g'ri tanlash va URL bilan bog'lash.",
    whyItMatters: "Katta APIlarda 70% endpointlar generic viewlar bilan yoziladi.",
    doNotStudyToday: ["ViewSet actions", "Complex permissions"],
    deepWorkPlan: standardDeepWork("Generic view turlari", "ListCreate va RUD ishlatish", "CRUD endpointlar yozish"),
    tasks: ["ListCreateAPIView yozish", "RetrieveUpdateDestroyAPIView yozish", "URL patternlarni ulash"],
    exercises: ["Create va Update uchun serializerlar alohida bo'lsa qanday yozishni sinang."],
    deliverable: "CRUD endpointlar generic view bilan ishlaydi.",
    checklist: ["List va create ishladi", "Update va delete ishladi"],
    readinessCriteria: ["GET/POST/PUT/DELETE hammasi ishlaydi."],
    commonMistakes: ["lookup_field unutish", "serializer_classni to'g'ri tanlamaslik"],
    ifStuck: "DRF generic view docs bo'limini o'qib chiqing.",
    terms: [
      { term: "ListCreateAPIView", definition: "List + Create CRUD operatsiyalarini bitta classda beradi." },
      { term: "RetrieveUpdateDestroyAPIView", definition: "Detail, update, delete uchun tayyor view." }
    ]
  },
  {
    dayNumber: 38,
    title: "ViewSets & Routers",
    shortDescription: "ModelViewSet, routerlar va actionlar",
    longDescription: "ViewSet API endpointlarni avtomatlashtiradi. Routerlar URLni avtomatik hosil qiladi. Bugun ViewSetning kuchini o'rganasiz.",
    category: "DRF Views, ViewSets & Routers",
    islandId: "drf-views",
    difficulty: "O'rtacha",
    todayFocus: "ModelViewSet, DefaultRouter, @action va custom endpointlar.",
    whyItMatters: "Katta APIda minimal kod bilan ko'p endpoint yoziladi.",
    doNotStudyToday: ["JWT", "Swagger docs"],
    deepWorkPlan: standardDeepWork("ViewSet nima", "Router bilan URL avtomat qilish", "Custom action bilan qo'shimcha endpoint"),
    tasks: ["ModelViewSet yozish", "DefaultRouter bilan register qilish", "Custom action yozish"],
    exercises: ["GET /books/top/ custom action yozing."],
    deliverable: "Router orqali ishlaydigan ViewSet va custom action.",
    checklist: ["Router URLlarni yaratdi", "Action endpoint ishladi"],
    readinessCriteria: ["CRUD + custom action bitta ViewSetda ishlaydi."],
    commonMistakes: ["basename unutish", "detail=True/False chalkashishi"],
    ifStuck: "DRF viewsets bo'limini ko'ring.",
    terms: [
      { term: "ViewSet", definition: "Bir nechta CRUD operatsiyani bitta classda jamlaydi." },
      { term: "Router", definition: "URL patternlarni avtomatik yaratadigan DRF vositasi." }
    ]
  },
  {
    dayNumber: 39,
    title: "Authentication Basics",
    shortDescription: "Session, Basic va Token authentication",
    longDescription: "Authentication foydalanuvchini aniqlaydi. DRFda bir nechta autentifikatsiya usullari bor. Bugun ularning farqini o'rganasiz.",
    category: "Auth, Permissions & API Security",
    islandId: "drf-auth",
    difficulty: "O'rtacha",
    todayFocus: "SessionAuthentication, BasicAuthentication, TokenAuthentication ishlatish.",
    whyItMatters: "Authsiz API ishonchsiz. Har bir requestda user aniqlanishi kerak.",
    doNotStudyToday: ["JWT deep dive", "OAuth"],
    deepWorkPlan: standardDeepWork("Auth turlari farqi", "Token auth sozlash", "Protected endpoint test qilish"),
    tasks: ["TokenAuthentication yoqish", "Obtain token endpoint yozish", "Auth header bilan so'rov qilish"],
    exercises: ["Auth bo'lmagan request 401 qaytarishini tekshiring."],
    deliverable: "Token auth ishlaydigan protected endpoint.",
    checklist: ["Token olindi", "Authorization header ishladi"],
    readinessCriteria: ["401/403 farqini tushuntira olasiz."],
    commonMistakes: ["Auth header formatini notog'ri yozish"],
    ifStuck: "DRF authentication bo'limini o'qing.",
    terms: [
      { term: "Authentication", definition: "Foydalanuvchi kimligini tekshirish jarayoni." },
      { term: "TokenAuthentication", definition: "Token orqali APIga kirish imkonini beradigan auth usuli." }
    ]
  },
  {
    dayNumber: 40,
    title: "Permissions & Custom Permission Classes",
    shortDescription: "IsAuthenticated, IsAdminUser va custom rules",
    longDescription: "Permissionlar foydalanuvchining nima qilishini belgilaydi. Bugun built-in va custom permission classlar yozishni o'rganasiz.",
    category: "Auth, Permissions & API Security",
    islandId: "drf-auth",
    difficulty: "O'rtacha",
    todayFocus: "permission_classes, object-level permission va custom rules.",
    whyItMatters: "Auth userni aniqlaydi, permission esa unga ruxsat beradi. Xavfsizlikning asosi.",
    doNotStudyToday: ["Swagger docs", "Caching"],
    deepWorkPlan: standardDeepWork("Built-in permissions", "Custom permission class yozish", "Object-level permission test"),
    tasks: ["IsAuthenticated va IsAdminUser ishlatish", "Custom permission class yozish", "Object-level check qo'shish"],
    exercises: ["Owner bo'lmagan user edit qila olmasligini tekshiring."],
    deliverable: "Custom permission bilan himoyalangan endpoint.",
    checklist: ["permission_classes ishladi", "custom rule ishladi"],
    readinessCriteria: ["403 qaytarilishini tushuntira olasiz."],
    commonMistakes: ["Permissionni faqat viewda tekshirish", "object permission unutish"],
    ifStuck: "DRF permissions docs bo'limini o'qing.",
    terms: [
      { term: "Permission", definition: "Userga amalni ruxsat berish qoidasi." },
      { term: "Object-level permission", definition: "Har bir obyekt uchun alohida ruxsat tekshiruvi." }
    ]
  },
  {
    dayNumber: 41,
    title: "JWT Authentication (SimpleJWT)",
    shortDescription: "Access/refresh token va stateless auth",
    longDescription: "JWT tokenlar stateless auth beradi. SimpleJWT bilan access/refresh token olish, yangilash va tekshirishni o'rganasiz.",
    category: "Auth, Permissions & API Security",
    islandId: "drf-auth",
    difficulty: "O'rtacha",
    todayFocus: "SimpleJWT setup, token endpoints, access/refresh flow.",
    whyItMatters: "Mobil va SPA ilovalar uchun JWT standart yechim. Sessionga bog'liq emas.",
    doNotStudyToday: ["OAuth2", "Social login"],
    deepWorkPlan: standardDeepWork("JWT mental modeli", "SimpleJWT o'rnatish va sozlash", "Login/refresh flowni test qilish"),
    tasks: ["djangorestframework-simplejwt o'rnatish", "TokenObtainPairView ulash", "Refresh token ishlatish"],
    exercises: ["Tokenni expire qilib, refresh bilan yangilang."],
    deliverable: "JWT auth ishlaydigan login va refresh endpointlar.",
    checklist: ["Access token ishladi", "Refresh token yangiladi"],
    readinessCriteria: ["Authorization: Bearer <token> bilan request ishladi."],
    commonMistakes: ["Bearer prefiksini unutish", "Tokenni clientda xavfsiz saqlamaslik"],
    ifStuck: "SimpleJWT docs bo'limini o'qing.",
    terms: [
      { term: "JWT", definition: "JSON Web Token - imzolanggan, stateless auth token." },
      { term: "Refresh token", definition: "Yangi access token olish uchun ishlatiladigan token." }
    ]
  },
  {
    dayNumber: 42,
    title: "Throttling & Rate Limiting",
    shortDescription: "UserRateThrottle va scoped throttles",
    longDescription: "Throttling APIga kelayotgan so'rovlar sonini cheklaydi. Bugun DRF throttling sozlamalarini o'rganasiz.",
    category: "Auth, Permissions & API Security",
    islandId: "drf-auth",
    difficulty: "O'rtacha",
    todayFocus: "DEFAULT_THROTTLE_CLASSES va rate limitlar.",
    whyItMatters: "Spam, bruteforce va DOS hujumlardan himoya qiladi.",
    doNotStudyToday: ["Caching", "Swagger docs"],
    deepWorkPlan: standardDeepWork("Throttling nima", "User/Anon throttles", "Scope bilan custom limit qo'yish"),
    tasks: ["UserRateThrottle yoqish", "AnonRateThrottle ishlatish", "ScopedRateThrottle qo'shish"],
    exercises: ["Limit oshganda 429 qaytishini test qiling."],
    deliverable: "Rate limit ishlaydigan API endpoint.",
    checklist: ["429 status chiqdi", "rate sozlangan"],
    readinessCriteria: ["Rate limit logikasini tushuntira olasiz."],
    commonMistakes: ["Cache backend sozlamaslik", "Throttle scope unutish"],
    ifStuck: "DRF throttling docs bo'limini o'qing.",
    terms: [
      { term: "Throttling", definition: "API requestlar sonini vaqt bo'yicha cheklash." },
      { term: "ScopedRateThrottle", definition: "Endpointga maxsus limit berish mexanizmi." }
    ]
  },
  {
    dayNumber: 43,
    title: "Filtering, Search & Ordering",
    shortDescription: "django-filter, SearchFilter va OrderingFilter",
    longDescription: "APIlar uchun filtering va search asosiy talab. Bugun django-filter va DRF filter backendlarini qo'llashni o'rganasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "FilterSet, search_fields va ordering_fields ishlatish.",
    whyItMatters: "Userlar APIdan kerakli datani tez topa oladi, backend esa nazoratli query beradi.",
    doNotStudyToday: ["JWT", "File uploads"],
    deepWorkPlan: standardDeepWork("Filter backendlar overview", "django-filter bilan field filterlar", "Search va orderingni test qilish"),
    tasks: ["DjangoFilterBackend qo'shish", "SearchFilter ishlatish", "OrderingFilter sozlash"],
    exercises: ["Category bo'yicha filter va title bo'yicha search yozing."],
    deliverable: "Filter, search va ordering ishlaydigan list endpoint.",
    checklist: ["filter ishladi", "search ishladi", "ordering ishladi"],
    readinessCriteria: ["URL query orqali filter va ordering ishlaydi."],
    commonMistakes: ["filterset_fields ni unutish", "search_fields notog'ri berish"],
    ifStuck: "django-filter docs bo'limini o'qing.",
    terms: [
      { term: "django-filter", definition: "DRF uchun kuchli filtering backend kutubxonasi." },
      { term: "SearchFilter", definition: "Search queryni fieldlar bo'yicha qidiradigan backend." }
    ]
  },
  {
    dayNumber: 44,
    title: "Pagination Strategies",
    shortDescription: "PageNumber, LimitOffset va Cursor pagination",
    longDescription: "Ko'p datani bitta responsega solish og'ir. Pagination APIni tez va boshqariladigan qiladi.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "Pagination classlar, page size, cursor pagination.",
    whyItMatters: "Performance va UX uchun har doim pagination kerak.",
    doNotStudyToday: ["Docs generatorlar", "Websocket"],
    deepWorkPlan: standardDeepWork("Pagination turlari farqi", "PageNumberPagination sozlash", "LimitOffset va Cursor bilan test"),
    tasks: ["PageNumberPagination yozish", "LimitOffsetPagination yozish", "CursorPagination bilan list endpoint"],
    exercises: ["page_size query param bilan boshqarishni qo'shing."],
    deliverable: "3 xil pagination bilan ishlaydigan list endpoint.",
    checklist: ["count/next/previous ishladi", "page size sozlandi"],
    readinessCriteria: ["Pagination response structure tushunarli."],
    commonMistakes: ["page_size notog'ri katta qilish", "ordering bermaslik"],
    ifStuck: "DRF pagination docs bo'limini o'qing.",
    terms: [
      { term: "Pagination", definition: "Ma'lumotni sahifalab qaytarish usuli." },
      { term: "CursorPagination", definition: "Katta datasetlar uchun barqaror pagination mexanizmi." }
    ]
  },
  {
    dayNumber: 45,
    title: "Parsers & Renderers",
    shortDescription: "JSONParser, FormParser va rendererlar",
    longDescription: "Parserlar inputni o'qiydi, rendererlar outputni formatlaydi. Bugun turli kontent turlarini boshqarishni o'rganasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "JSONParser, MultiPartParser, JSONRenderer va BrowsableAPIRenderer.",
    whyItMatters: "API turli clientlardan kelgan ma'lumotni to'g'ri o'qishi kerak.",
    doNotStudyToday: ["JWT", "Rate limiting"],
    deepWorkPlan: standardDeepWork("Parser va renderer farqi", "Multipart input qabul qilish", "Browsable API sozlash"),
    tasks: ["parser_classes berish", "renderer_classes berish", "multipart endpoint yozish"],
    exercises: ["Form data bilan POST yuborib ko'ring."],
    deliverable: "Turli content-type qabul qiladigan endpoint.",
    checklist: ["multipart input o'qildi", "json renderer ishladi"],
    readinessCriteria: ["Content-Type bo'yicha parser ishlaydi."],
    commonMistakes: ["Parser classlarini unutish", "Multipartda request.data bo'sh chiqishi"],
    ifStuck: "DRF parser/renderer docs bo'limini o'qing.",
    terms: [
      { term: "Parser", definition: "Request bodyni Python dictga aylantiradigan DRF komponenti." },
      { term: "Renderer", definition: "Python datani response formatga chiqaradigan komponent." }
    ]
  },
  {
    dayNumber: 46,
    title: "File Uploads & Media APIs",
    shortDescription: "FileField, ImageField va upload endpointlar",
    longDescription: "File upload DRFda multipart orqali amalga oshadi. Bugun fayl qabul qilish va validationni o'rganasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "File upload, size/type validation, Media URL.",
    whyItMatters: "Real loyihalarda avatar, dokument, image upload bo'ladi.",
    doNotStudyToday: ["JWT", "Caching"],
    deepWorkPlan: standardDeepWork("File upload flow", "Serializerda FileField", "Upload endpointni test qilish"),
    tasks: ["ImageField qo'shish", "Multipart parser qo'shish", "Upload view yozish"],
    exercises: ["5MB dan katta faylni bloklash validatori yozing."],
    deliverable: "Fayl qabul qiladigan API endpoint va media sozlamasi.",
    checklist: ["MEDIA_URL ishladi", "FileField saqlandi"],
    readinessCriteria: ["Postman orqali fayl upload qilish ishladi."],
    commonMistakes: ["MEDIA_ROOT sozlamaslik", "Multipart parserni unutish"],
    ifStuck: "DRF file upload docs bo'limini o'qing.",
    terms: [
      { term: "FileField", definition: "Fayl saqlash uchun model field." },
      { term: "Multipart", definition: "Fayl va form datani birga yuborish formati." }
    ]
  },
  {
    dayNumber: 47,
    title: "Exception Handling & Error Responses",
    shortDescription: "APIException, custom handler va error format",
    longDescription: "API error format yagona bo'lishi kerak. DRF exception handler orqali barcha xatolarni bir formatda chiqarasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "APIException, custom exception handler, error response schema.",
    whyItMatters: "Clientlar xatoni to'g'ri tushunadi va frontendda logika yozish osonlashadi.",
    doNotStudyToday: ["Docs generator", "Caching"],
    deepWorkPlan: standardDeepWork("DRF exception flow", "Custom handler yozish", "Error response formatni standartlash"),
    tasks: ["Custom exception class yozish", "Exception handler sozlash", "Error schema qaytarish"],
    exercises: ["ValidationError va APIException farqini test qiling."],
    deliverable: "Yagona error formatga ega API.",
    checklist: ["Handler ishladi", "Error format bir xil"],
    readinessCriteria: ["400/403/500 errorlar bir xil struktura bilan qaytadi."],
    commonMistakes: ["Exception handlerni settingsga yozmaslik"],
    ifStuck: "DRF exception handling docs bo'limini o'qing.",
    terms: [
      { term: "APIException", definition: "DRFdagi standart exception class." },
      { term: "Exception handler", definition: "Barcha exceptionlarni formatlaydigan funksiya." }
    ]
  },
  {
    dayNumber: 48,
    title: "Testing DRF APIs",
    shortDescription: "APITestCase, APIClient va force_authenticate",
    longDescription: "Testlarsiz API ishonchsiz. DRF test client orqali endpointlarni tekshirasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "APITestCase, APIRequestFactory va auth testlari.",
    whyItMatters: "Regression va xatolarni early topish uchun test muhim.",
    doNotStudyToday: ["Deployment", "CI/CD"],
    deepWorkPlan: standardDeepWork("Test base setup", "APIClient bilan CRUD test", "Auth va permission testlari"),
    tasks: ["APITestCase yozish", "force_authenticate ishlatish", "status code assertion yozish"],
    exercises: ["Permission 403 qaytarishini test qiling."],
    deliverable: "CRUD endpointlar uchun testlar to'plami.",
    checklist: ["Testlar o'tadi", "Auth testlar bor"],
    readinessCriteria: ["pytest yoki manage.py test orqali yashil testlar."],
    commonMistakes: ["Test data tayyorlamaslik", "reverse notog'ri ishlatish"],
    ifStuck: "DRF testing docs bo'limini o'qing.",
    terms: [
      { term: "APITestCase", definition: "DRF test class, APIClient bilan ishlaydi." },
      { term: "APIClient", definition: "HTTP requestlarni test qilish uchun client." }
    ]
  },
  {
    dayNumber: 49,
    title: "Schema & API Documentation",
    shortDescription: "OpenAPI schema va Swagger/Redoc",
    longDescription: "API documentation - backendning pasporti. DRF schema generatorlar bilan avtomatik docs chiqarish oson.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "drf-spectacular yoki schema view bilan OpenAPI docs.",
    whyItMatters: "Frontend va mobile jamoa API ni tez tushunadi va integratsiya tezlashadi.",
    doNotStudyToday: ["Caching", "Performance tuning"],
    deepWorkPlan: standardDeepWork("Schema nima", "drf-spectacular sozlash", "Swagger/Redoc endpointlar"),
    tasks: ["drf-spectacular o'rnatish", "SchemaView ulash", "Swagger UI ochish"],
    exercises: ["Schema ichida custom fieldlarni to'g'ri ko'rsating."],
    deliverable: "Swagger/Redoc orqali ko'rinadigan API docs.",
    checklist: ["Schema chiqdi", "Endpoints to'g'ri ko'rindi"],
    readinessCriteria: ["/api/schema/ va /api/docs/ ishlaydi."],
    commonMistakes: ["Schema generatorni INSTALLED_APPS ga qo'ymaslik"],
    ifStuck: "drf-spectacular docs bo'limini ko'ring.",
    terms: [
      { term: "OpenAPI", definition: "API endpointlarini standart formatda hujjatlashtirish spesifikatsiyasi." },
      { term: "Swagger", definition: "OpenAPI docsni ko'rish uchun UI." }
    ]
  },
  {
    dayNumber: 50,
    title: "API Versioning",
    shortDescription: "URL, header va namespace versioning",
    longDescription: "API yangilansa eski clientlar buzilmasligi kerak. Versioning shuni ta'minlaydi.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "URLPathVersioning, HeaderVersioning va default version.",
    whyItMatters: "Backward compatibility - real productlar uchun muhim.",
    doNotStudyToday: ["JWT", "Throttling"],
    deepWorkPlan: standardDeepWork("Versioning mental modeli", "URL versioning sozlash", "Header versioning test qilish"),
    tasks: ["DEFAULT_VERSIONING_CLASS sozlash", "v1/v2 endpoint yozish", "Header orqali version test"],
    exercises: ["v1 va v2 uchun serializer farqini bering."],
    deliverable: "Versioning ishlaydigan 2 ta endpoint.",
    checklist: ["v1/v2 ishladi", "Default version sozlandi"],
    readinessCriteria: ["Client version orqali turli response oladi."],
    commonMistakes: ["Versioning class qo'ymaslik", "url patternlarda clash"],
    ifStuck: "DRF versioning docs bo'limini o'qing.",
    terms: [
      { term: "Versioning", definition: "API ning turli versiyalarini boshqarish strategiyasi." },
      { term: "URLPathVersioning", definition: "URL ichida v1/v2 ko'rinishida version berish." }
    ]
  },
  {
    dayNumber: 51,
    title: "Caching & Performance for APIs",
    shortDescription: "cache_page, conditional GET va fast responses",
    longDescription: "API tezligi user tajribasini belgilaydi. Bugun cache va conditional response ishlatishni o'rganasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "cache_page, low-level cache va ETag/If-None-Match.",
    whyItMatters: "Caching server yukini kamaytiradi va response tezligini oshiradi.",
    doNotStudyToday: ["Swagger", "Versioning"],
    deepWorkPlan: standardDeepWork("Cache strategiyalar", "cache_page qo'llash", "Conditional GET sinash"),
    tasks: ["cache_page decorator qo'shish", "Low-level cache ishlatish", "ETag headerni test"],
    exercises: ["Cache invalidation uchun signal yozing."],
    deliverable: "Cache bilan tez ishlaydigan list endpoint.",
    checklist: ["Cache hit/miss tushunarli", "Cache invalidation ishladi"],
    readinessCriteria: ["Ikkinchi request tezlashdi."],
    commonMistakes: ["Cache timeoutni notog'ri berish"],
    ifStuck: "Django cache docs bo'limini o'qing.",
    terms: [
      { term: "Cache", definition: "Tezkor xotirada response yoki data saqlash." },
      { term: "ETag", definition: "Conditional GET uchun response identifikatori." }
    ]
  },
  {
    dayNumber: 52,
    title: "N+1 Optimization in DRF",
    shortDescription: "select_related/prefetch_related APIda ishlatish",
    longDescription: "Serializerlar nested datani chiqarishda N+1 muammosi tug'dirishi mumkin. Bugun optimizatsiya qilasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "queryset optimizatsiya, serializer performance, select_related.",
    whyItMatters: "N+1 performance muammosi katta projectlarda sekinlik keltiradi.",
    doNotStudyToday: ["JWT", "Docs"],
    deepWorkPlan: standardDeepWork("N+1 muammosi mental modeli", "select_related/prefetch_related", "Serializer bilan profiling"),
    tasks: ["select_related qo'llash", "prefetch_related ishlatish", "Django debug toolbar bilan tekshirish"],
    exercises: ["Nested serializerga optimizatsiya qo'shing."],
    deliverable: "N+1 bartaraf qilingan API endpoint.",
    checklist: ["Query soni kamaydi", "Response tezlashdi"],
    readinessCriteria: ["SQL querylar sonini tushuntira olasiz."],
    commonMistakes: ["Serializer ichida query yozish"],
    ifStuck: "Django ORM optimizatsiya bo'limini o'qing.",
    terms: [
      { term: "N+1", definition: "1 ta asosiy query va har bir obyekt uchun qo'shimcha querylar chiqishi muammosi." },
      { term: "select_related", definition: "FK relationlarni join bilan bitta queryda olish." }
    ]
  },
  {
    dayNumber: 53,
    title: "Signals, Webhooks & Background Tasks",
    shortDescription: "post_save signal, webhook va celery tasklar",
    longDescription: "API real vaqtda boshqa tizimlarga signal yuboradi. Signals va background tasklar bilan ishlashni o'rganasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "post_save signal, webhook endpoint, celery task trigger.",
    whyItMatters: "Asinxron ishlar API tezligini saqlab qoladi.",
    doNotStudyToday: ["Pagination", "Docs"],
    deepWorkPlan: standardDeepWork("Signal flow", "Webhook endpoint dizayni", "Celery task trigger"),
    tasks: ["post_save signal yozish", "Webhook endpoint yaratish", "Celery task chaqirish"],
    exercises: ["Order yaratganda email task qo'shing."],
    deliverable: "Signal va task orqali ishlaydigan asinxron flow.",
    checklist: ["Signal ishladi", "Task queuega tushdi"],
    readinessCriteria: ["Task natijasi loglarda ko'rinadi."],
    commonMistakes: ["Signal logikasini viewga yozib qo'yish"],
    ifStuck: "Django signals docs bo'limini o'qing.",
    terms: [
      { term: "Signal", definition: "Model eventlari bo'lganda avtomatik trigger bo'ladigan hook." },
      { term: "Webhook", definition: "Boshqa servisga HTTP callback yuborish usuli." }
    ]
  },
  {
    dayNumber: 54,
    title: "API Security Hardening",
    shortDescription: "CORS, CSRF, secure headers va permissions",
    longDescription: "API xavfsizligi uchun CORS, CSRF va security headerlarni to'g'ri sozlash kerak. Bugun himoya qatlamlarini o'rganasiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "CORS sozlash, CSRF, secure headers, permission kombinatsiya.",
    whyItMatters: "Xavfsizliksiz API productionga chiqarilmaydi.",
    doNotStudyToday: ["Swagger", "Versioning"],
    deepWorkPlan: standardDeepWork("CORS va CSRF tushunchalari", "Security headerlar", "Permission + auth kombinatsiyasi"),
    tasks: ["django-cors-headers sozlash", "CSRFni to'g'ri boshqarish", "Secure headers qo'shish"],
    exercises: ["CORS faqat 2 ta domen uchun ruxsat bering."],
    deliverable: "CORS va security headerlari sozlangan API.",
    checklist: ["CORS ishladi", "Security headerlar ko'rindi"],
    readinessCriteria: ["Browserdan cross-origin request ishladi."],
    commonMistakes: ["CORSni * qilib qo'yish"],
    ifStuck: "Django security docs bo'limini o'qing.",
    terms: [
      { term: "CORS", definition: "Cross-Origin Resource Sharing - brauzer requestlarini boshqarish qoidasi." },
      { term: "CSRF", definition: "Cross-Site Request Forgery hujumlaridan himoya." }
    ]
  },
  {
    dayNumber: 55,
    title: "Audit Logging & Rate Policies",
    shortDescription: "Audit loglar va limit siyosati",
    longDescription: "Katta tizimlarda kim nima qilganini yozib borish kerak. Audit loglar va rate policy bilan nazorat o'rnatiladi.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "Audit model, action logging, throttle scope siyosati.",
    whyItMatters: "Xatolarni topish va compliance uchun audit log muhim.",
    doNotStudyToday: ["Docs", "Pagination"],
    deepWorkPlan: standardDeepWork("Audit log model", "Action logging", "Throttle policy sozlash"),
    tasks: ["AuditLog model yozish", "View actionni log qilish", "Throttle scope policy berish"],
    exercises: ["DELETE operatsiyalarni alohida log qiling."],
    deliverable: "Audit log yoziladigan API flow.",
    checklist: ["Log yozildi", "User/action ko'rindi"],
    readinessCriteria: ["Audit logdan 1 ta actionni ko'rsata olasiz."],
    commonMistakes: ["Audit logni async qilmaslik"],
    ifStuck: "Logging best practices bo'limini o'qing.",
    terms: [
      { term: "Audit log", definition: "Kim, qachon, nima qilganini saqlovchi yozuv." },
      { term: "Policy", definition: "APIga qo'yilgan qoidalar to'plami." }
    ]
  },
  {
    dayNumber: 56,
    title: "Deployment & Env Config for APIs",
    shortDescription: "Production sozlamalar va env config",
    longDescription: "API productionga chiqishi uchun DEBUG, ALLOWED_HOSTS, secure settings va env config to'g'ri bo'lishi kerak.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "Production settings, env, static/media va security settings.",
    whyItMatters: "Notog'ri konfiguratsiya productionda xavf va downtime keltiradi.",
    doNotStudyToday: ["JWT", "Websocket"],
    deepWorkPlan: standardDeepWork("Prod config checklist", "Env filelarni ajratish", "Deploymentga tayyorlash"),
    tasks: ["DEBUG=False sozlash", "ALLOWED_HOSTS to'g'ri berish", "SECURE_* settinglarni sozlash"],
    exercises: ["Staging va prod uchun alohida env yarating."],
    deliverable: "Productionga tayyor API settings.",
    checklist: ["DEBUG o'chdi", "ALLOWED_HOSTS to'g'ri"],
    readinessCriteria: ["Security headerlar yoqilgan."],
    commonMistakes: ["DEBUGni prodga olib chiqish"],
    ifStuck: "Django deployment docs bo'limini o'qing.",
    terms: [
      { term: "ALLOWED_HOSTS", definition: "Django qaysi domenlardan request qabul qilishini belgilaydi." },
      { term: "SECURE_*", definition: "Security uchun HTTP header va cookie sozlamalari." }
    ]
  },
  {
    dayNumber: 57,
    title: "Monitoring, Logging & Error Tracking",
    shortDescription: "Logging config va Sentry integratsiyasi",
    longDescription: "Productionda muammolarni tez topish uchun logging va monitoring kerak. Bugun log format va Sentry sozlaysiz.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "LOGGING dict, request tracing, Sentry integratsiya.",
    whyItMatters: "Xatolarni real vaqt ko'rish va tez fix qilish imkonini beradi.",
    doNotStudyToday: ["Pagination", "JWT"],
    deepWorkPlan: standardDeepWork("Logging levels", "Django LOGGING sozlash", "Sentryga error yuborish"),
    tasks: ["LOGGING config yozish", "Request ID loglash", "Sentry DSN ulash"],
    exercises: ["Custom exceptionni Sentryga yuborishni test qiling."],
    deliverable: "Loglar va error tracking ishlaydigan API.",
    checklist: ["Loglar yozildi", "Sentryda issue chiqdi"],
    readinessCriteria: ["Error loglarni tushuntira olasiz."],
    commonMistakes: ["Log formatni juda katta qilish"],
    ifStuck: "Django logging docs bo'limini o'qing.",
    terms: [
      { term: "Logging", definition: "Dasturdagi hodisalarni yozib borish." },
      { term: "Sentry", definition: "Error tracking va monitoring platformasi." }
    ]
  },
  {
    dayNumber: 58,
    title: "Clean Architecture for DRF",
    shortDescription: "Service layer, selectors va serializers ajratish",
    longDescription: "Katta APIda viewlar faqat orchestration bo'lishi kerak. Service layer va selectors orqali clean architecture quriladi.",
    category: "Filtering, Pagination & Docs",
    islandId: "drf-advanced",
    difficulty: "O'rtacha",
    todayFocus: "Service layer, selectors, viewset clean pattern.",
    whyItMatters: "Code base oson testlanadi va kengayadi.",
    doNotStudyToday: ["Swagger", "Pagination"],
    deepWorkPlan: standardDeepWork("Clean architecture mental modeli", "Service layer yozish", "Selectors bilan query boshqarish"),
    tasks: ["services.py yaratish", "selectors.py yaratish", "ViewSet ichida service chaqirish"],
    exercises: ["Create logikasini viewdan servicega ko'chiring."],
    deliverable: "Service layer bilan clean API endpoint.",
    checklist: ["View yupqa bo'ldi", "Service test qilinadi"],
    readinessCriteria: ["View faqat input/response bilan ishlaydi."],
    commonMistakes: ["Biznes logikani serializerga yozish"],
    ifStuck: "Clean architecture patternlarini takrorlang.",
    terms: [
      { term: "Service layer", definition: "Biznes qoidalarni saqlovchi qatlam." },
      { term: "Selector", definition: "Querylarni markazlashtirish uchun qatlam." }
    ]
  },
  {
    dayNumber: 59,
    title: "Capstone Planning & API Design",
    shortDescription: "Final loyiha dizayni va API contract",
    longDescription: "Final DRF loyihadan oldin API contract, endpoints va data modelni rejalaysiz.",
    category: "DRF Checkpoint",
    islandId: "drf-checkpoint-final",
    difficulty: "O'rtacha",
    todayFocus: "Endpointlar ro'yxati, model schema va API contract.",
    whyItMatters: "Rejasiz loyiha ko'p vaqt oladi. Dizayn vaqtni tejaydi.",
    doNotStudyToday: ["Frontend UI", "Microservices"],
    deepWorkPlan: standardDeepWork("API design mental modeli", "Endpoint va model design", "Capstone plan yozish"),
    tasks: ["Entity list tuzish", "Endpoint mapping yozish", "Permissions va auth plan tuzish"],
    exercises: ["Swagger orqali endpointlarni chizib chiqing."],
    deliverable: "Final API dizayn hujjati (endpointlar, model diagram).",
    checklist: ["Endpoint list tayyor", "Model schema tayyor"],
    readinessCriteria: ["Capstone ishini ertaga boshlab ketasiz."],
    commonMistakes: ["Model diagram chizmaslik", "Endpointlarni chalkashtirish"],
    ifStuck: "Oldingi kunlardagi notesni qayta ko'ring.",
    terms: [
      { term: "API contract", definition: "Client va server o'rtasidagi response/request kelishuvi." },
      { term: "Endpoint map", definition: "CRUD va action endpointlar ro'yxati." }
    ]
  },
  {
    dayNumber: 60,
  ...
  },
  {
    dayNumber: 61,
    title: 'Katta loyiha',
    shortDescription: 'Darsdagi qiyin nuqtalarni AI bilan topib, teacherga real vaqt signal beradigan product.',
    longDescription: 'Katta loyihada siz Django/DRF, Postgres, Redis, Celery va Google GenAI integratsiyasini bitta real mahsulotga yig\'asiz. Bu capstone darsda siz data pipeline, AI analiz, permissionlar, testlar, monitoring va deploygacha bo\'lgan to\'liq flow ni yakunlab, production-ready API yaratasiz.',
    category: 'AI Product Capstone',
    islandId: 'ai-confusion-radar',
    difficulty: 'Qiyin',
    todayFocus: 'AI signal pipeline, role-based access va production konfiguratsiya bir joyda ishlashini ta\'minlash.',
    whyItMatters: 'Real ishda sizdan faqat CRUD emas, balki data oqimini boshqarish, AI servislarni xavfsiz ulash va monitoring bilan ishlaydigan backend kutiladi.',
    doNotStudyToday: ['Frontend UI dizayn', 'No-code AI tools', 'Faqat demo uchun yozilgan kodlar'],
    deepWorkPlan: [
      { label: 'Scope & Domain Model', durationMinutes: 75, description: 'Course, Lesson, Session, Chat/Note va Confusion signal modellari' },
      { label: 'AI Pipeline & Signals', durationMinutes: 120, description: 'Google GenAI promptlari, JSON parsing va signal scoring' },
      { label: 'API & Production Ready', durationMinutes: 90, description: 'Auth/permission, caching, test va deploy konfiguratsiya' }
    ],
    tasks: [
      'AI radar uchun asosiy modellar va endpointlarni yozing',
      'Celery task orqali AI analizni asinxron ishlating',
      'Auth/permission va caching bilan production flow qiling'
    ],
    exercises: [
      'Confusion score uchun formula yozing va 3 ta test case bilan tekshiring.'
    ],
    deliverable: 'To\'liq ishlaydigan Katta loyiha API: Postgres + Redis + Celery + GenAI integratsiyasi bilan.',
    checklist: [
      'Signals jadvali va AI natijalari saqlanyapti',
      'Permissions role bo\'yicha to\'g\'ri ishlaydi',
      'Docker compose bilan lokal muhit ishladi'
    ],
    readinessCriteria: [
      'Teacher dashboardi uchun kerakli API lar tayyor',
      'AI analiz pipeline xatolarga chidamli'
    ],
    commonMistakes: [
      'AI javobini to\'g\'ri parse qilmaslik',
      'Background taskni request ichida to\'g\'ridan-to\'g\'ri ishga tushirish',
      'Multi-tenant cheklovini unutish'
    ],
    ifStuck: 'Avval domen modelini to\'liq chizing, keyin AI va API qatlamiga o\'ting. Har bosqichni alohida testlab boring.',
    terms: [
      { term: 'Confusion signal', definition: 'Dars jarayonida qiyin bo\'lgan topic yoki joyni ko\'rsatuvchi signal.' },
      { term: 'AI prompt guard', definition: 'AI javobini JSON formatda va xavfsiz olish uchun qo\'shimcha qoidalar.' },
      { term: 'Risk score', definition: 'Topic bo\'yicha xavf darajasi (0-1 oralig\'ida) hisoblangan ko\'rsatkich.' }
    ]
  }
];
