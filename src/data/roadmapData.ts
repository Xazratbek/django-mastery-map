...
export const islands: IslandData[] = [
  ...
  { id: 'django-backend-funds', title: 'Django Backend Core', category: 'Django Backend Fundamentals', x: 1500, y: 5150, color: '#10b981', glowColor: 'rgba(16, 185, 129, 0.4)' },
  { id: 'django-db', title: 'Models, Migrations & ORM', category: 'Models, Migrations & ORM', x: 2500, y: 4700, color: '#f59e0b', glowColor: 'rgba(245, 158, 11, 0.4)' },
  { id: 'django-auth', title: 'Auth & Logic', category: 'Auth, Validation & Business Logic', x: 1400, y: 4250, color: '#ec4899', glowColor: 'rgba(236, 72, 153, 0.4)' },
  { id: 'django-arch', title: 'Architecture & Testing', category: 'Project Structure & Clean Architecture', x: 2600, y: 3800, color: '#8b5cf6', glowColor: 'rgba(139, 92, 246, 0.4)' },
  { id: 'django-perf', title: 'Performance & Security', category: 'Performance, Security & Testing', x: 1600, y: 3350, color: '#ef4444', glowColor: 'rgba(239, 68, 68, 0.4)' },
  { id: 'django-checkpoint', title: 'Junior Django Checkpoint', category: 'Django Checkpoint', x: 2000, y: 2900, color: '#eab308', glowColor: 'rgba(234, 179, 8, 0.6)' },
  { id: 'drf-setup', title: 'REST API Foundations', category: 'API & REST Foundations', x: 2400, y: 2450, color: '#3b82f6', glowColor: 'rgba(59, 130, 246, 0.4)' },
  { id: 'drf-serializers', title: 'Serializers & Validation', category: 'DRF Setup & Serializers', x: 1500, y: 2000, color: '#06b6d4', glowColor: 'rgba(6, 182, 212, 0.4)' },
  { id: 'drf-views', title: 'Views & ViewSets', category: 'DRF Views, ViewSets & Routers', x: 2500, y: 1550, color: '#6366f1', glowColor: 'rgba(99, 102, 241, 0.4)' },
  { id: 'drf-auth', title: 'Security, JWT & Permissions', category: 'Auth, Permissions & API Security', x: 1400, y: 1100, color: '#a855f7', glowColor: 'rgba(168, 85, 247, 0.4)' },
  { id: 'drf-advanced', title: 'Advanced DRF (Filter, Docs)', category: 'Filtering, Pagination & Docs', x: 2300, y: 650, color: '#14b8a6', glowColor: 'rgba(20, 184, 166, 0.4)' },
  { id: 'drf-checkpoint-final', title: 'DRF Complete Capstone', category: 'DRF Checkpoint', x: 2000, y: 200, color: '#f43f5e', glowColor: 'rgba(244, 63, 94, 0.6)' },
];
